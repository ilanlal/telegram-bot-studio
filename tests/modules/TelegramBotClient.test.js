...
describe("TelegramBotClient", () => {
    ...
    const telegramBotClient = new Common.Modules.TelegramBotClient(sampleToken);
    ...
    describe("Common.Modules.TelegramBotClient setMyName, setMyDescription, setMyShortDescription Tests", () => {
